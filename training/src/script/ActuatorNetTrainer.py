...
class ActuatorNetTrainer:
    ...
    def load_data(self, file_path):
        ...
        Returns:
            tuple: Arrays of position errors, velocities, torques and temperature.
        """
    ...
    def prepare_sequence_data(self, position_errors, velocities, torques, temperatures):
    ...
    def prepare_data(self, train_data_path, val_data_path):
        ...
        train_temperatures = self.normalize_data(train_temperatures, -MAX_TEMPERATURE, MAX_TEMPERATURE)
    ...
    def log_metrics(self, epoch, num_epochs, train_loss, val_loss, lr, epoch_duration, total_train_time, is_best, save_path, writer):
        ...
        writer.add_scalar('Epoch Duration (seconds)', epoch_duration, epoch)
        writer.add_scalar('Total Training Time (seconds)', total_train_time, epoch)
    ...
    def train_model(self, train_data_path, val_data_path, 
        ...
        for epoch in range(num_epochs):
            ...
            self.log_metrics(epoch, num_epochs, train_loss, val_loss, optimizer.param_groups[0]['lr'], 
                             epoch_duration, total_train_time, is_best, save_path, writer)
